...
#define BAUD_RATE 9600      //default baud rate UART0
#define BAUD_RATES 115200      //default baud rate UART2
...
void uart2_init(){
	...
	// P3.3 = TxD
	// P3.2 = RxD
	// we will be using P3.2, P3.3 for RX and TX but not in I/O mode, so we set 
  // Port1 SEL1=0 and SEL0=1
	// set SEL0, SEL1 appropriately
  P3->SEL0 |=BIT2;
  P3->SEL1 &=~BIT2;
